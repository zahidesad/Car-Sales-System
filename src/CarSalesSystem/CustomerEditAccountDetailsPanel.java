 ...
 * @author zahid
 */
public class CustomerEditAccountDetailsPanel extends javax.swing.JPanel implements ITriggerer {
    ...
    public CustomerEditAccountDetailsPanel() {
        initComponents();
    }
    ...
    public void PageOn() {
        ...
        txtPhoneNo.setText(customer.getPhone() + "");
